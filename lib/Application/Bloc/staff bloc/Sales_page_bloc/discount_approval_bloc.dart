...
class StaffBloc{
  ...
  final _dropDownField4 = BehaviorSubject<String>.seeded("Item list 1");
  ...
  Function(String) get inDropField4 => _dropDownField3.sink.add;
  ...
  Stream<String> get outDropField4  => _dropDownField3.stream;
...
class DiscountApprovalProvider extends InheritedWidget{
  final StaffBloc bloc;

  DiscountApprovalProvider({Key key, Widget child})
      :bloc = StaffBloc(),
