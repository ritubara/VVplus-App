...
class BranchToBranchReceiveBloc{
  // Declare streams
...
class BranchToBranchReceiveProvider extends InheritedWidget{
  final BranchToBranchReceiveBloc bloc;

  BranchToBranchReceiveProvider({Key key, Widget child})
      :bloc = BranchToBranchReceiveBloc(),
        super(key : key, child : child);

  @override
  bool updateShouldNotify(_) => true;

  static BranchToBranchReceiveBloc of (BuildContext context){
    return (context.dependOnInheritedWidgetOfExactType<BranchToBranchReceiveProvider>())
        .bloc;
  }
