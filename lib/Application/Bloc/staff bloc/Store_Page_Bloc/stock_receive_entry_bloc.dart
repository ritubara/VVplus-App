...
class StockReceiveEntryProvider extends InheritedWidget{
  final StockReceiveEntryBloc bloc;

  StockReceiveEntryProvider({Key key, Widget child})
      :bloc = StockReceiveEntryBloc(),
        super(key : key, child : child);

  @override
  bool updateShouldNotify(_) => true;

  static StockReceiveEntryBloc of (BuildContext context){
    return (context.dependOnInheritedWidgetOfExactType<StockReceiveEntryProvider>())
        .bloc;
  }
