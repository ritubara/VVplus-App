...
class PhaseToPhaseTransferBloc{
  // Declare streams
...
class PhaseToPhaseTransferProvider extends InheritedWidget{
  final PhaseToPhaseTransferBloc bloc;

  PhaseToPhaseTransferProvider({Key key, Widget child})
      :bloc = PhaseToPhaseTransferBloc(),
        super(key : key, child : child);

  @override
  bool updateShouldNotify(_) => true;

  static PhaseToPhaseTransferBloc of (BuildContext context){
    return (context.dependOnInheritedWidgetOfExactType<PhaseToPhaseTransferProvider>())
        .bloc;
  }
