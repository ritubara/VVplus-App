...
class StockIssueEntryProvider extends InheritedWidget{
  final StockIssueEntryBloc bloc;

  StockIssueEntryProvider({Key key, Widget child})
      :bloc = StockIssueEntryBloc(),
        super(key : key, child : child);

  @override
  bool updateShouldNotify(_) => true;

  static StockIssueEntryBloc of (BuildContext context){
    return (context.dependOnInheritedWidgetOfExactType<StockIssueEntryProvider>())
        .bloc;
  }
