...
class PlacePurchaseOrderProvider extends InheritedWidget{
  final PlacePurchaseOrderBloc bloc;

  PlacePurchaseOrderProvider({Key key, Widget child})
      :bloc = PlacePurchaseOrderBloc(),
        super(key : key, child : child);

  @override
  bool updateShouldNotify(_) => true;

  static PlacePurchaseOrderBloc of (BuildContext context){
    return (context.dependOnInheritedWidgetOfExactType<PlacePurchaseOrderProvider>())
        .bloc;
  }
