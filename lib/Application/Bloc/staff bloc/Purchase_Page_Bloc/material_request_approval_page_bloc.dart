...
class MaterialRequestApprovalBloc{
  // Declare streams
...
class MaterialRequestApprovalProvider extends InheritedWidget{
  final MaterialRequestApprovalBloc bloc;

  MaterialRequestApprovalProvider({Key key, Widget child})
      :bloc = MaterialRequestApprovalBloc(),
        super(key : key, child : child);

  @override
  bool updateShouldNotify(_) => true;

  static MaterialRequestApprovalBloc of (BuildContext context){
    return (context.dependOnInheritedWidgetOfExactType<MaterialRequestApprovalProvider>())
        .bloc;
  }
