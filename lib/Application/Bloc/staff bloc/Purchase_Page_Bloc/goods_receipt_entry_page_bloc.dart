...
class GoodsReceiptEntryProvider extends InheritedWidget{
  final GoodsReceiptEntryBloc bloc;

  GoodsReceiptEntryProvider({Key key, Widget child})
      :bloc = GoodsReceiptEntryBloc(),
        super(key : key, child : child);

  @override
  bool updateShouldNotify(_) => true;

  static GoodsReceiptEntryBloc of (BuildContext context){
    return (context.dependOnInheritedWidgetOfExactType<GoodsReceiptEntryProvider>())
        .bloc;
  }
