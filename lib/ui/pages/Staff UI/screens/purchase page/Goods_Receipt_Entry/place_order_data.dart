...
class GoodsReceiptEntryContainerData extends StatefulWidget {
  const GoodsReceiptEntryContainerData({Key key}) : super(key: key);

  @override
  _GoodsReceiptEntryContainerDataState createState() =>
      _GoodsReceiptEntryContainerDataState();
}

class _GoodsReceiptEntryContainerDataState extends State<GoodsReceiptEntryContainerData> {
